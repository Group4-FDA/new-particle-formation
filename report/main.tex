...
\title{Introduction to Machine Learning - Project Report - Team FDA}
\author{Alisa Elizarova, Daniel Cauchi, Fahsinee Wachirapong}
\date{\today}
%\prof{Professor X or Dr. Y}
%\censors{Professor A}{Dr. B}{}
\keywords{Machine Learning, New Particle Formation}
\depositeplace{}
...
\input{subfiles/data_exploration}
\input{subfiles/methodology}
\input{subfiles/results}

\input{subfiles/conclusion} % .5 pgs
