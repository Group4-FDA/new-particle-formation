"""
Do PCA on the dataset and see where the best threshold lies
"""
...
df = pd.read_csv('resources/data/generated/train_train.csv')
...
fig, ax = plt.subplots()
xi = np.arange(1, len(feature.columns) + 1, step=1)
...
plt.xticks(np.arange(0, len(feature.columns) + 1, step=1))
...
# explained variance tells how much infomation (variance) can be attributed
